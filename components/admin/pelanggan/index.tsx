...
import DataPelanggan from "./table";
  ...
  return (
    ...
    >
      <Breadcrumbs>
        ...
        <Crumb>
          <UsersIcon />
          <CrumbLink href="/admin/pelanggan">Pelanggan</CrumbLink>
          <Text>/</Text>
        </Crumb>
        <Crumb>
      ...
      <DataPelanggan search={search} data={data} />
    </Flex>
  );
};

export default PelangganContent;
